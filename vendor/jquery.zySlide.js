...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            // { '&zIndex': 1, width: 700, height: 300, top: 65, left: 0, $opacity: 0.5 },
            // { '&zIndex': 2, width: 1000, height: 500, top: 60, left: 0, $opacity: 0.7 },
            // { '&zIndex': 3, width: 1220, height: 610, top: 0, left: 1000, $opacity: 1 },
            // { '&zIndex': 2, width: 1000, height: 500, top: 60, left: 2220, $opacity: 0.7 },
            // { '&zIndex': 1, width: 700, height: 300, top: 65, left: 2120, $opacity: 0.5 }
            { '&zIndex': 1, width: this.options.ulWidth*0.2, height: this.options.ulHeight*0.5, top: this.options.ulHeight*0.25, left: 0, $opacity: 0.5 },
            { '&zIndex': 2, width: this.options.ulWidth*0.3, height: this.options.ulHeight*0.8, top: this.options.ulHeight*0.1, left: 0, $opacity: 0.7 },
            { '&zIndex': 3, width: this.options.ulWidth*0.4, height: this.options.ulHeight, top: 0, left: this.options.ulWidth*0.3, $opacity: 1 },
            { '&zIndex': 2, width: this.options.ulWidth*0.3, height: this.options.ulHeight*0.8, top: this.options.ulHeight*0.1, left: this.options.ulWidth*0.7, $opacity: 0.7 },
            { '&zIndex': 1, width: this.options.ulWidth*0.2, height: this.options.ulHeight*0.5, top: this.options.ulHeight*0.25, left: this.options.ulWidth*0.6, $opacity: 0.5 }
